...
const FaviconOrLetter: React.FC<{ title: string; url: string; iconSize: number }> = ({ title, url, iconSize = 32 }) => {
  ...
  return <div 
    className={clsx(
      `relative flex items-center justify-center w-16 h-16 mb-2 rounded-2xl backdrop-blur-sm shadow-[0_0_6px_rgb(0_0_0/0.1)] transition-all duration-200 overflow-hidden`,
